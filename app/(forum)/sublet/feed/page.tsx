...
export default function SubletFeed() {
  // Get mock sublet posts
  const allPosts = getMockPostsByCategory(PostCategory.SUBLET);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Sublet Listings</h1>
        <p className="text-gray-600 mt-2">
          {response.meta.totalCount} sublets available
        </p>
      </div>
